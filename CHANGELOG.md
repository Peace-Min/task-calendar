...
- **과제 필터 영역 높이 사용자 조절**: 우측 패널 과제 필터가 84px 고정 스크롤이던 것을 `resize:vertical`로 **드래그 높이 조절** 가능하게(min 42px). 높이는 localStorage 영속·재렌더 복원(mouseup 시 저장, box-sizing border-box로 드리프트 없음). *(과제 많을 때 단순 스크롤 불편 피드백)*
