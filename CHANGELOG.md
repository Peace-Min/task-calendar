...
## 🆕 2026-07-10 — v0.9.0: 사내 배포 정식 릴리스 (0.8.x 통합 · FTP 기본값 비움)
...
- **`DefaultUpdateSourceUrl = ""`**(비움): 배포판은 자동 업데이트 **휴면** 상태로 나감 — 배포자가 각 PC 설정에서 소스 URL을 넣거나, 최종 FTP 확정 후 상수에 박아 재빌드해야 자동 업데이트가 켜짐(사용자 요청 "배포전 ftp 주소는 비워놔").
