...
async function main() {
  ...
  //  자리 계약(2026-09-18) — 상단 막대는 「순서 편집」 · 「퇴사자 휴지통」 · 「직급·소속 관리」 셋이고 그 뒤가 「퇴사자 보기」다.
  ...
  okq('상단 막대는 「순서 편집」 · 「퇴사자 휴지통」 · 「직급·소속 관리」 셋이다', JSON.stringify(bar0.ids) === JSON.stringify(['uaOrderEdit', 'uaTrash', 'uaOrgTitle']), JSON.stringify(bar0.ids));
